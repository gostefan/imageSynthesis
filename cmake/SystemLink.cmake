...
function(
  ...
  if(TARGET ${lib})
    ...
    elseif(${lib} STREQUAL "freeglut_static")
      message(TRACE "Do special treatment for freeglut - its include dirs work for this.")
      get_target_property(lib_build_include_dirs ${lib} INCLUDE_DIRECTORIES)
      if(lib_build_include_dirs)
        target_include_system_directories(${target} ${scope} ${lib_build_include_dirs})
      endif()
    else()
