...
//**********************************************
{
  ...
  const float tmp=(1.0f/static_cast<float>(M_PI))/(np.dist2[0]);	// estimate of density
...
#define swapP(ph,a,b) { Photon *ph2=ph[a]; ph[a]=ph[b]; ph[b]=ph2; }
...
int Photon_map::getStoredPhotons() {
