...
#include "RenderApp\Scene\HitInfo.h"

CheckerboardTexture::CheckerboardTexture(float frequencyX_in, float frequencyY_in, float frequencyZ_in, Color3f color1_in, Color3f color2_in) : 
		frequencyX(frequencyX_in), frequencyY(frequencyY_in), frequencyZ(frequencyZ_in), color1(color1_in), color2(color2_in) { };
